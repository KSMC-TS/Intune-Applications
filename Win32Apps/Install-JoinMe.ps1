...
$appname = "join.me" #needs to match Uninstall DisplayName in Registry
$appurl = "https://join.me/Download.aspx?installer=win" #url to pull app from (GitHub, Azure Blob, etc.)
