...
$appname = "Chrome" #needs to match Uninstall DisplayName in Registry
$appurl = "https://dl.google.com/chrome/install/googlechromestandaloneenterprise64.msi" #url to pull app from (GitHub, Azure Blob, etc.)
