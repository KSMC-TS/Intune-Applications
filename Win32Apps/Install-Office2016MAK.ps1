...
$appname = "Microsoft Office 2016" #needs to match Uninstall DisplayName in Registry
$appurl = "" #url to pull app from (GitHub, Azure Blob, etc.)
$addtlargs = "/adminfile DOLO16INSTALL.MSP" #any additional args needed for install command
$installertype = "exe" # 'msi' or 'exe'
$localinstaller = "Setup.exe" # name of installer file
