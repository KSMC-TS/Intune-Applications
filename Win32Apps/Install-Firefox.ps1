...
$appname = "firefox" #needs to match Uninstall DisplayName in Registry
$appurl = "https://download.mozilla.org/?product=firefox-latest-ssl&os=win64&lang=en-US" #url to pull app from (GitHub, Azure Blob, etc.)
